...
PrioVis.prototype.updateVis = function () {
    ...
    var text = self.visG.selectAll("text.bar").data(self.displayData)
 ...
 * @param selection
 */
PrioVis.prototype.onSelectionChange = function (selectionStart, selectionEnd,flag) {
    var self = this;
    self.flag=flag;
 ...
 * @constructor
 */
function PrioVis1 (_parentElement, _data, _metaData) {
    /**
     * A word about "this":
     *
     * The meaning of "this" can change from function call to function call; the way
 ...
 * Method should be called as soon as data is available.. sets up the SVG and the variables
 */
PrioVis1.prototype.initVis = function () {
    var self = this; // read about the this
 ...
 * @param _filterFunction - a function that filters data or "null" if none
 */
PrioVis1.prototype.wrangleData = function (_filterFunction) {
    var self = this;
 ...
 * the drawing function - should use the D3 selection, enter, exit
 */
PrioVis1.prototype.updateVis = function () {
 ...
 * @param selection
 */
PrioVis1.prototype.onSelectionChange = function (selectionStart, selectionEnd,flag) {
    var self = this;
    self.flag=flag;
    // call wrangleData with a filter function
    self.wrangleData(function (data) {
 ...
 * @returns {Array|*}
 */
PrioVis1.prototype.filterAndAggregate = function (_filter) {
    var self = this;
